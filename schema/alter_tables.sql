/* This code updates the database schema by renaming columns 
	...
	-- insurance_claim
ALTER TABLE insurance RENAME COLUMN ClaimID TO claim_id;
ALTER TABLE insurance RENAME COLUMN ChargeID TO charge_id;
ALTER TABLE insurance RENAME COLUMN InsuranceProvider TO insurance_provider;
ALTER TABLE insurance RENAME COLUMN AmountBilled TO amount_billed;
ALTER TABLE insurance RENAME COLUMN AmountPaid TO amount_paid;
ALTER TABLE insurance RENAME COLUMN Status TO status;
